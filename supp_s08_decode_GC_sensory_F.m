...
function supp_s08_decode_GC_sensory_F(arrayInput)
...
trainProp = '0.7'; % this prooprtion of training trials
...
for thisCVRep = 1:nCVReps
    ...
    for higherIdx = 1:length(possHigherCoords)
        ...
        for lowerIdx = 1:length(possLowerCoords)
            ...
            savename_Results = ['results_GC_toFFA_ForwardsFrom_Occ_rmline_' (PName) '_' (thisPhase) '_CVmethod_10REPS_GC_' num2str(maxFreq) 'Hz_MultiROI_' ...
